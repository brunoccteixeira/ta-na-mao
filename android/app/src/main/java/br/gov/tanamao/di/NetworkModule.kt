...
import br.gov.tanamao.BuildConfig
...
object NetworkModule {
    ...
    // URL is configured via local.properties TANAMAO_API_URL
    // For emulator: http://10.0.2.2:8000/api/v1/
    // For physical device: http://192.168.x.x:8000/api/v1/
    // For production: https://api.tanamao.gov.br/api/v1/
    private val BASE_URL: String = BuildConfig.TANAMAO_API_URL
