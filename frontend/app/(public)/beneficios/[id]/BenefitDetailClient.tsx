...
export default function BenefitDetailClient({ id }: { id: string }) {
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center">
        <div className="flex items-center gap-3 text-[var(--text-tertiary)]">
          ...
          <span>Carregando beneficio...</span>
        </div>
      </div>
    );
  }
  ...
  const scopeLabel = () => {
    switch (benefit.scope) {
      case 'federal': return 'Beneficio Federal';
      case 'state': return `Beneficio Estadual - ${getStateName(benefit.state || '')}`;
      case 'sectoral': return 'Beneficio Setorial';
      case 'municipal': return 'Beneficio Municipal';
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-2xl mx-auto">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`px-2 py-0.5 rounded text-xs font-medium ${
                            ...
                            {law.type === 'constituicao' ? 'Constituicao' :
                             law.type === 'lei' ? 'Lei' :
          ...
          <div className="mt-8 pt-6 border-t border-[var(--border-color)] space-y-3">
            ...
            >
              Ver todos os beneficios que posso receber
            </Link>
          </div>
        </div>
      </main>
