...
import CaseList from '../../src/components/Admin/CaseList';
      ...
      <div className="max-w-6xl mx-auto p-4">
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <KPICard label="Casos Abertos" value={stats.openCases} color="text-yellow-400" bg="bg-yellow-500/10 border-yellow-500/20" />
            <KPICard label="Em Andamento" value={stats.inProgressCases} color="text-purple-400" bg="bg-purple-500/10 border-purple-500/20" />
            <KPICard label="Resolvidos (mes)" value={stats.resolvedThisMonth} color="text-emerald-400" bg="bg-emerald-500/10 border-emerald-500/20" />
            <KPICard label="Total Resolvidos" value={stats.totalResolved} color="text-blue-400" bg="bg-blue-500/10 border-blue-500/20" />
          </div>
        )}
