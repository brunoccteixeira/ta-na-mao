/**
 * Home - Landing page inspirada no Wizbii Money
      ...
      <header className="fixed top-0 left-0 right-0 bg-[var(--bg-header)] backdrop-blur-sm border-b border-[var(--border-color)] z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center gap-4">
            <Link to="/beneficios" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] text-sm hidden sm:inline">
              Catálogo
            </Link>
            <Link to="/sobre" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] text-sm hidden sm:inline">
              Sobre
            </Link>
            <Link
              to="/descobrir"
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 relative hidden md:block">
              <div className="relative w-full max-w-md mx-auto h-80">
                ...
                {/* Floating cards */}
                <div className="absolute top-4 right-0 bg-white rounded-xl shadow-lg p-3 border border-gray-100 animate-[float_3s_ease-in-out_infinite]">
                ...
                <div className="absolute top-28 -left-4 bg-white rounded-xl shadow-lg p-3 border border-gray-100 animate-[float_3s_ease-in-out_infinite_0.5s]">
                  <p className="text-xs text-gray-500">Farmácia Popular</p>
                  <p className="text-emerald-600 font-bold">100% grátis</p>
                </div>

                <div className="absolute bottom-8 right-4 bg-white rounded-xl shadow-lg p-3 border border-gray-100 animate-[float_3s_ease-in-out_infinite_1s]">
        ...
        <section className="bg-[var(--bg-card)] border-y border-[var(--border-color)] py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
              <StatCard value={229} suffix="+" label="Benefícios mapeados" />
              <StatCard value={27} suffix="" label="Estados cobertos" />
      ...
      <footer className="border-t border-[var(--border-color)] py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[var(--text-tertiary)] text-xs mt-2 opacity-60">
            Tá na Mão © 2025 - Feito para ajudar
          </p>
        </div>
      </footer>
    </div>
