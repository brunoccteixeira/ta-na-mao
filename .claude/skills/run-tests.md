...
@pytest.fixture
def mock_beneficio():
    return {"programa": "Bolsa Família", "valor": 600.0}
```
...
- `backend/.coveragerc` - Configuração coverage
