...
mcp__playwright__browser_type selector=".chat-input textarea" text="quero consultar meus benefícios"
```
...
# Digitar mensagem
mcp__playwright__browser_type selector=".chat-input textarea" text="quais benefícios tenho direito?"
...
### 2. Testar Consulta de Benefícios
```
# Navegar para página de benefícios
mcp__playwright__browser_navigate url="http://localhost:5173/beneficios"
