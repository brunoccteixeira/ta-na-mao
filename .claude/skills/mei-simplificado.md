...
⚠️ É DE GRAÇA. Se alguém cobrar, é golpe.
```
...
ALERTAS_MEI = {
    "das_vencendo": {
        ...
        "mensagem": "Atenção: o DAS (boleto do MEI) vence dia 20. Valor: R${valor}. Pague na lotérica ou pelo app MEI."
    },
    "dasn_vencendo": {
        "mes": 4,  # abril, 1 mês antes
        "mensagem": "A declaração anual do MEI (DASN) vence em 31 de maio. Acesse gov.br/mei para declarar."
    },
    "desenquadramento": {
        "trigger": "faturamento > 81000",
        "mensagem": "Seu faturamento passou de R$81.000 no ano. Você precisa mudar para Microempresa (ME). Procure um contador."
    },
}
```
...
Hoje você ganha: R$ {{renda_atual}}/mês
Com MEI: R$ {{renda_com_mei}}/mês
Custo do MEI: R$ {{das}}/mês
Você ganharia a mais: R$ {{ganho_liquido}}/mês

{{#se_mantem_beneficio}}
E o melhor: seu {{beneficio}} NÃO seria afetado!
{{/se_mantem_beneficio}}

Além disso, com MEI você ganha:
✅ Aposentadoria
✅ Auxílio se ficar doente
✅ Pode emitir nota fiscal
✅ Crédito mais fácil no banco
```
